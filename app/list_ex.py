...
element_at_index_0 = r.index("mylist", 0)
...
# Find the 2-based postion of 'apple' in the list
position_rank2 = r.lpos("fruits", "apple", rank=2)
print("2-based position of 'apple' in the list:", position_rank2)

# Find the postion of 'banana' in the list with MAXLEN=4
...
print("Position of the second occurrence of 'apple' in the list  ")

# Set the value of the lement at index 2 to "new_value"
...
# Trim the list to contain only elements from index 1 to 3
r.ltrim("fruits", 1, 2)
